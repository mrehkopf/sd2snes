...
create_clock -name {CLKIN} -period 125.0 -waveform { 0.000 62.5 } [get_ports {CLKIN}]
create_clock -name {SPI_SCK} -period 20.833 -waveform { 0.000 10.416 } [get_ports {SPI_SCK}]
