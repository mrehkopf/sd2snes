...
overflows_t1_regtimeout_start       EQU 0x22
overflows_t1_regtimeout_reset       EQU 0x22
overflows_t1_regtimeout_dblreset    EQU 0x39
...
start
    ...
    M_movlf 0xc0, OPTION_REG    ; global pullup disable, use rising data clock edge for interrupt
    banksel PORTA
...
idle_loop
    ...
    goto    waitforlatch_l                  ; if yes - wait for latch become low
...
dl1_wait
    btfss   INTCON, INTF            ; wait for clk=h
    goto    dl1_wait
    movfw   PORTA                   ; read data bit
